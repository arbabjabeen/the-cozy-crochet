...
export const products: Product[] = [
  {
    slug: "crochet-lavender-flower-keychain-1358",
    name: "Crochet Lavender Flower Keychain",
    category: "keychain",
    price: 3,
    originalPrice: 5,
    onSale: true,
    ...
    badge: "Sale",
    description: "Handcrafted lavender flower keychain made with pure cotton yarn.",
    stock: 10,
    rating: 5,
    numReviews: 2,
  },
