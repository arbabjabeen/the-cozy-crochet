...
import { PageIntro, StoreShell } from "@/components/storefront";
...
export const Route = createFileRoute("/cart")({
  head: () => ({
    meta: [
      { title: "Your Bag — The Cozy Crochet" },
      { name: "description", content: "Review your selected handmade crochet pieces." },
      { property: "og:title", content: "Your Bag — The Cozy Crochet" },
      { property: "og:description", content: "Review your handmade crochet order." },
...
function Cart() {
  const { items, updateQuantity, removeFromCart, subtotal, giftWrap, setGiftWrap } = useCart();
